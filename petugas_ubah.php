...
<h1 class="h3 mb-3">Ubah Data Petugas</h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="level" class="form-select">
                                        <option <?php if($data['level'] == 'petugas') echo 'selected'; ?> value="petugas">Petugas</optiion>
                                        <option <?php if($data['level'] == 'admin') echo 'selected'; ?> value="admin">Administrator</optiion>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
